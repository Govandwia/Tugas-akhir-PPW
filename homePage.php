...
<body>
    ...
    <section class="hero-section">
        <div class="hero-left">
            <h1 class="hero-text"> FIND YOUR <br>DREAM LAPTOP</h1>
            <P class="hero-par">Explore Our Curated Selection of Exquisite <br>Laptops Meticulously Tailored to Your Unique <br>Needs and Preferences</P>
        ...
        <div class="products-list">
            <ul>
                <?php 
                    ...
                    $quer = "SELECT * FROM product WHERE ProductID IN (1,2,3,4,5)";
    ...
    <footer>
        <div class="footer-container">
            <div class="footer-item">
                ...
                <p>Explore Our Curated Selection of Exquisite <br>Laptops Meticulously Tailored to Your Unique <br>Needs and Preferences</p>
